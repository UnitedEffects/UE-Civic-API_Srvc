...
var callbackFactory = {
    ...
    fail422: function(message){
        return {
            err: 422,
            data: (message) ? message : 'There was some sort of error in processing your request, however, it is not fatal and the error may correct itself.'
        }
    },
